...
<img src="../../src/assets/img/hackathon_questions.jpg" alt="Hackathon Questions" style="margin: 0 auto; border-radius: 0.5%; display: block; box-shadow: 0 0 20px rgba(0, 0, 0, 0.15); max-width: 60%; overflow: clip; border: 0;" />
 ...
 &nbsp;&nbsp;&nbsp;&nbsp;If you are interested and want to see the project my teammate has written a perfect blog explaining how you can program this type of product yourself, here's the <a href="https://haxbabatech.blogspot.com/2020/04/build-your-own-red-team-dropbox-for_9.html" style="color: #f3865f; font-weight: bold; text-decoration: none;">EXPLANATION</a>  – check it out. Anyway I did not explain any programming stuff we did in the project, this was just my experience, visit <a href="https://haxbabatech.blogspot.com/2020/04/build-your-own-red-team-dropbox-for_9.html" style="color: #f3865f; font-weight: bold; text-decoration: none;">THIS</a>   for more coding stuff, it's REALLY good. 
