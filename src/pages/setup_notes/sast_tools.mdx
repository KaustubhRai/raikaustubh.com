...
And before running this tools, whenever you download a repo to scan, ALWAYS `git clone` it, dont download it directly as a zip form the UI. Since its not initialized as a git repo, the tools dont work properly. 
